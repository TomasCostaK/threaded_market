...
public class OIS_Main {
     ...
     public static void main(String args[]) {
        ...
        final AEControl control = new AEControl( (IIdle_Control) idle, (IOutsideHall_Control) outsideHall, (IEntranceHall_Control) entranceHall, (ICorridorHall_Control[]) corridorHalls, (ICorridor_Control[]) corridors);
